const copy = {
  ja: {
    ...
    proofKicker: 'START WITHOUT SIGN-UP', proofTitle: '登録なしで始める。必要なときだけ、自分のAIをつなぐ。', proofIntro: 'Infinite Canvasはブラウザですぐに開けます。ボードは自分のPCに保存し、必要になったらローカルComfyUIやOpenRouterなどの任意BYOKを追加できます。',
    proofEvidenceAria: 'Infinite Canvasの検証証拠',
    proofDetailsSummary: '技術検証の詳細を見る',
  ...
  en: {
    ...
    proofKicker: 'START WITHOUT SIGN-UP', proofTitle: 'Start without an account. Connect your own AI when you need it.', proofIntro: 'Open Infinite Canvas in the browser now. Keep boards on your own computer, then add local ComfyUI or optional international BYOK services when your work needs them.',
    proofEvidenceAria: 'Infinite Canvas verification evidence',
    proofDetailsSummary: 'View technical verification',
  ...
  zh: {
    ...
    proofKicker: 'START WITHOUT SIGN-UP', proofTitle: '无需注册即可开始，需要时再连接你自己的 AI。', proofIntro: '现在就能在浏览器中打开 Infinite Canvas。画布保存在自己的电脑上；需要时，再连接本地 ComfyUI 或 OpenRouter 等可选国际 BYOK 服务。',
    proofEvidenceAria: 'Infinite Canvas 验证证据',
    proofDetailsSummary: '查看技术验证详情',
