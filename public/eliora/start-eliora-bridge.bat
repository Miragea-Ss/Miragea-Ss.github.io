...
where py >nul 2>&1 && set "ELIORA_PY=py" && set "ELIORA_PY_PREFIX=-3" && goto :run
...
:run
echo Starting bridge with: %ELIORA_PY% %ELIORA_PY_PREFIX%
"%ELIORA_PY%" %ELIORA_PY_PREFIX% "%~dp0eliora-comfy-bridge.py"
pause
