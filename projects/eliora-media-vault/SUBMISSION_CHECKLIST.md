...
Safety deadline: 2026-07-30 JST

Official deadline: 2026-08-03 17:00 EDT / 2026-08-04 06:00 JST

## Product evidence

- [x] Functional public app exists.
- [x] Three representative assets appear in the catalog.
- [x] All three records have completed B2 runs and non-null manifest URIs.
- [x] All three records include canonical hashes and asset SHA-256 values.
- [x] Browser-side SHA-256 verification works.
- [x] Real Genblaze Pipeline source exists.
- [x] ComfyUI API and honest existing-file fallback exist.
- [x] Credential-safe B2 proof export exists.
...
## Devpost — user approval/action required

- [ ] Join/log in to the hackathon account if Devpost asks.
- [ ] Enter the working app URL.
- [ ] Enter the public GitHub source URL.
...
- [ ] Save the Devpost confirmation page or email as evidence.

## Optional feedback prize

- [ ] Prepare one substantive Genblaze issue or feature request.
- [ ] Publish it only after user approval.
